...
8. [Step 6 — Register in config.yaml](#8-step-6--register-in-configyaml)
9. [Step 7 — Test without real credentials](#9-step-7--test-without-real-credentials)
...
## 8. Step 6 — Register in config.yaml
...
plugins:
  ...
  gmail:    gmail_plugin        # ← add your plugin here
```

Then add the new plugin type to `_FACTORIES` in `integrations/__init__.py`:
...
_FACTORIES: dict[str, str] = {
    ...
    "ai":       "create_ai_provider",
    "platform": "create_platform_bot",
    "gmail":    "create_gmail_integration",   # ← add this line
}
```
